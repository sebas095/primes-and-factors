...
test('test results', (t) => {
  ...
  // Integer input > 1.5
    [120, false, [2, 2, 2, 3, 5], [2, 3, 5], [{ factor: 2, times: 3 }, { factor: 3, times: 1 }, { factor: 5, times: 1 }]]
  ...
  , [65536, false, [2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2], [2], [{ factor: 2, times: 16 }]]
  , [65537, true, [65537], [65537], [{ factor: 65537, times: 1 }]]
  , [1531250, false, [2, 5, 5, 5, 5, 5, 5, 7, 7], [2, 5, 7], [{ factor: 2, times: 1 }, { factor: 5, times: 6 }, { factor: 7, times: 2 }]]
